...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn btn-link bold sw-btn-next btn-lg').attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('btn btn-link bold sw-btn-prev btn-lg').attr('type', 'button') : null;
            var btnGroup = $('<div></div>').addClass('btn-group navbar-btn sw-btn-group float-none').attr('role', 'group').append(btnPrevious, btnNext);
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    ...
                    break;
                case 'bottom':
                    toolbarBottom = $('<nav></nav>').addClass('navbar btn-toolbar text-center sw-toolbar sw-toolbar-bottom');
...
var swiper = new Swiper('.offers-swiper .swiper-container', {
    slidesPerView: 1,
    spaceBetween: 0,
    autoplay: 7000,
    loop: true,
...
///////////////////////////////////////////////////////////////////////
// swiper = new Swiper('.manufacture-swiper-container', {
//   slidesPerView: 6,
...
///////////////////////////////////////////////////////////////////////
var swiperhome = new Swiper('.category-home', {
    slidesPerView: 4,
    spaceBetween: 15,
    autoplay: 7000,
...
///////////////////////////////////////////////////////////////////////
var swiperads = new Swiper('.ads-swiper', {
    slidesPerView: 1,
    autoplay: 1000,
    loop: true,
    preventClicks: false,
